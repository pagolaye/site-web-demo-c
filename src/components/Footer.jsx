...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          >
            <div className="flex items-center">
              <Smartphone className="h-10 w-10 text-teal-300 mr-3" />
              <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-300 to-cyan-300">
                AMOGO Tech
              </span>
            </div>
          ...
          >
            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a href={link.href} className="text-gray-300 hover:text-white transition duration-300 flex items-center">
