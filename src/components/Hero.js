...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-r from-blue-700 to-purple-700 text-white py-32 lg:py-48 overflow-hidden">
      <motion.div 
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between relative z-10 h-full">
        ...
        >
          ...
          >
            Transférez de l'argent en un <span className="text-yellow-300">instant</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          <div className="flex space-x-4">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-white text-blue-700 font-semibold py-3 px-6 rounded-lg flex items-center justify-center hover:bg-blue-50 transition duration-300"
            >
        ...
        >
          ...
          />
          <motion.div
            className="absolute -bottom-10 -left-10 w-40 h-40 bg-yellow-300 rounded-full"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
