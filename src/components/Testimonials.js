...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-20 bg-gradient-to-b from-purple-100 to-indigo-100">
      <div className="container mx-auto px-4">
        ...
        >
          Ce que Disent Nos <span className="text-purple-600">Utilisateurs</span>
        </motion.h2>
        <motion.div
        ...
        >
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-indigo-500"
            >
